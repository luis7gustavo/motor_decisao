...
from motor_decisao.pipelines.common.playwright_browser import chromium_page
from motor_decisao.pipelines.market_web.parsing import clean_text, detect_block, parse_brl_price
from motor_decisao.pipelines.price_history.base import PriceHistorySnapshot
from motor_decisao.pipelines.price_history.comparison_scraper import SOURCE_BASE_URLS
