...
| Fonte de dados | MegaMix (`data/raw/megamix_catalog_raw.json`), Mirão via web scraper, Coletek via planilha, Mercado Livre, Amazon, Kabum, Terabyte, Shopee, AliExpress, Pichau, Magalu, Zoom e Buscapé. Os dados são armazenados em PostgreSQL nas camadas Bronze, Silver e Gold. |
